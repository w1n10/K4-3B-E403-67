...
| **Tỷ lệ vượt qua (Pass Rate)** | **100.0%** (45/45) | ≥ 85.0% | **PASS** |
| **Checklist chuẩn hóa** | **7 ý (K1..K7)** + **3 lỗi (M1..M3)** | 5–7 mục theo spec §3.1 | Khớp 100% |
| **Thời gian thực thi** | 137 ms | < 2000 ms | Rất nhanh |
...
|---|---|---|---|---|
| **③ Ngoài phạm vi / thẩm quyền** | 9 | 9 | **100.0%** | Hoàn hảo |
...
| `TC03` | ③ Ngoài phạm vi / thẩm quyền | tutor_turns.csv (T | LLM = cỗ máy Transformer đoán token tiếp theo... | `verbatim_copy` | `-` | ✅ PASS |
